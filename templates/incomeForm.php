	...
	<article>
		<div class="container" >
			<div class = "row justify-content-around" id="content">
					...
					<form action ="index.php?action=addIncome" 
								   method = "post">
						<div class="input-group input-group-sm mb-3">
							<div class="input-group-prepend">
								<span class="input-group-text" id="inputGroup-sizing-sm"><i class="icon-vector-pencil"></i></span>
							</div>
							<input type="text" class="form-control" placeholder="Kwota" name="price" aria-label="Login" aria-describedby="inputGroup-sizing-sm">
						</div>
						<div class="input-group input-group-sm mb-3">
							<div class="input-group-prepend">
								<span class="input-group-text" id="inputGroup-sizing-sm"><i class="icon-calendar"></i></span>
							</div>
							<input type="date" class="form-control" name="date"  aria-label="Date" aria-describedby="inputGroup-sizing-sm" value="<?php $date = new DateTime(); echo $date->format('Y-m-d');  ?>">
						</div>		
						<div class="form-group">
							<select class="form-control form-control-sm" id="incomes_category" name="category">
